    ...
    const [messages, setMessages] = useState([
        {
            ...
            sender: 'ai',
            type: 'text',
            content: "Hello! I'm your AI travel assistant. How can I help you plan your customized trip today? I can help with itineraries, safety tips, and estimated costs in ₹ (INR)."
        }
    ]);
